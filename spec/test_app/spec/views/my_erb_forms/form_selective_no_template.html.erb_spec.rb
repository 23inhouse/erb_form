...
describe "my_erb_forms/form_selective_no_template" do
  before(:each) do
  ...
  describe "when calling form_for" do
    it "renders a text_field with template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
        form.should_not have_selector "fieldset div.field:nth-child(1)"
    ...
    it "renders a text_area template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
    ...
    it "renders a check_box template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
    ...
    it "renders a radio_button template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
    ...
    it "renders a date_select template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
    ...
    it "renders a select template => false" do
      render
      rendered.should have_selector "form.selective_no_template" do |form|
